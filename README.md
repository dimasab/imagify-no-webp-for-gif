...
First, you'll need to download the plugin as a *.zip file. Please go to this page <a target="_blank" href="https://github.com/dimasab/imagify-no-webp-for-gif/blob/main/imagify-no-webp-for-gif.zip">imagify-no-webp-for-gif.zip</a>, click on the three-dot icon on the right side of your screen, and then click **Download**.
